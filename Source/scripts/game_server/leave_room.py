...
MESSAGE_NAME = "LeaveRoomRequest"

ROOM_NAME = "some"
ROOM_USER = "some_user_2"

PUBLISH_TOPIC = "gg_rooms_req"
PUBLISH_ROUTE = "leave_room" + "." + ROOM_NAME + "." + ROOM_USER
...
class LeaveRoomMessage():
    def __init__(self,  player: str, roomName: str):
...
new_game_data = LeaveRoomMessage(ROOM_USER, ROOM_NAME)
